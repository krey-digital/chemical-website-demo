...
export default function ProductForm({ product, mode }: ProductFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    images: product?.images || [], // Product images with primary flag
    ...
    isDraft: product?.isDraft !== false, // Default to true (draft) for new products
  ...
  const handleSubmit = async (action: "draft" | "publish") => {
    ...
    try {
      ...
      if (mode === "create") {
        ...
        if (action === "publish" && product.isDraft) {
